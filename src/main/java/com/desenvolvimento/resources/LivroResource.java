...
public class LivroResource {
    ...
    public ResponseEntity<LivroDTO> delete(@PathVariable Long id){ //na apostila fala para deixar em grupoprodutoDTO, mas se for colocar aqui teria que ser 2 deletes
